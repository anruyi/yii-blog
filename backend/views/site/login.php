...
<div class="panel signin">
    ...
    <div class="panel-body">
        ...
        <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
            ...
            <?= $form->field($model, 'username', [
                ...
                'inputTemplate' =>
                    '<div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-align-left"></i></span>{input}
                    </div>',
            ...
            <div><a href="#" class="forgot"></a>忘记密码</div>
        <hr class="visible">
            <div class="form-group">
                <?= Html::submitButton('登陆', ['class' => 'btn btn-primary btn-quirk btn-block', 'name' => 'login-button']) ?>
            </div>
